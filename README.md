...
<h4>Projects that I build independently using the knowledge and skills I have learned.</h4>

<h3>3. My Strong Projects⭐</h3>

<h4>A collection of selected projects that I consider my strongest work and want to showcase.</h4>

---

<h3>My Goal</h3>

<h4>Learn → Practice → Build → Improve → Create real-world projects.</h4>
